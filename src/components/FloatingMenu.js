...
const FloatingMenu = () => {
  const [menuExpaned, setMenuExpanded] = useState(false);
  ...
  return (
    <div className={`list-container ${menuExpaned ? "active" : ""}`}>
      <button className="more-button" onClick={handleMenuExpanded}>
